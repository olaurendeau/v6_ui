goog.provide('app.ImageFiltersController');
 ...
 * @ngInject
 */
app.ImageFiltersController = function($scope, ngeoLocation, ngeoDebounce,
...
goog.inherits(app.ImageFiltersController, app.SearchFiltersController);
 ...
 * @public
 */
app.ImageFiltersController.prototype.getFilterFromPermalink = function(key) {
 ...
 * @export
 */
app.ImageFiltersController.prototype.clear = function() {
  this.resetDates_();
 ...
 * @export
 */
app.ImageFiltersController.prototype.setDate = function(filterName) {
...
// date_time: "2016-11-27T16:16:11+01:00",
 ...
 * @private
 */
app.ImageFiltersController.prototype.formatDate_ = function(date) {
 ...
 * @private
 */
app.ImageFiltersController.prototype.updateMinMaxDates_ = function() {
 ...
 * @private
 */
app.ImageFiltersController.prototype.resetDates_ = function() {
  this.dates = [];
  this.dateMaxStart = new Date();
  this.dateMaxEnd = new Date();
  this.dateMinEnd = null;
...
app.module.controller('appImageFiltersController', app.ImageFiltersController);
